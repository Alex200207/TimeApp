  ...
  return (
    <div className="relative">
      <Input
        ...
        className="w-[280px] bg-slate-800/20 border-0 text-white placeholder:text-white/50 focus-visible:ring-1 focus-visible:ring-white/30"
      />
      ...
      {inputValue.length >= 3 && (
        <div className="absolute w-[280px] mt-1 bg-slate-800/95 backdrop-blur-sm rounded-lg border border-white/10 shadow-xl">
          {loading ? (
            ...
            <div className="py-1">
              {cities.map((city, index) => (
                ...
                >
                  <MapPin className="w-3.5 h-3.5 text-white/50 group-hover:text-white/70" />
